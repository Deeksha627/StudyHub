...
const AdminPanel = () => {
    ...
    const [userCount] = useState(42); // example count
    ...
    const documents = [
        { id: 1, title: "Student Feedback Form", type: "Form", lastUpdated: "2 days ago", status: "Active" },
        { id: 2, title: "Project Submission Guidelines", type: "Document", lastUpdated: "1 week ago", status: "Draft" },
        { id: 3, title: "Event Registration Form", type: "Form", lastUpdated: "3 days ago", status: "Active" },
        { id: 4, title: "Achievement Certificate Template", type: "Template", lastUpdated: "5 days ago", status: "Active" }
    ];
